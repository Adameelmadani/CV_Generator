...
echo "<h1><i class="fas fa-wrench"></i> Installation des tables pour les nouvelles fonctionnalités</h1>";
...
try {
    ...
    echo "<h2><i class="fas fa-clipboard"></i> Exécution des requêtes SQL...</h2>";
    ...
    foreach ($queries as $query) {
        ...
        try {
            ...
            if (stripos($query, 'SELECT') === 0) {
                ...
                echo "<i class="fas fa-check-circle"></i> Requête exécutée avec succès ($affectedRows lignes affectées)";
                echo "</div>";
            }
    ...
    echo "<h2><i class="fas fa-chart-bar"></i> Résumé de l'installation</h2>";
    ...
    foreach ($tables as $table) {
        try {
            ...
            echo "<p><i class="fas fa-check-circle"></i> Table <strong>$table</strong>: $count enregistrements</p>";
        } catch (PDOException $e) {
            echo "<p><i class="fas fa-times-circle"></i> Table <strong>$table</strong>: Erreur - " . $e->getMessage() . "</p>";
        }
    }
    echo "</div>";
    
    // Test des API
    echo "<h2><i class="fas fa-flask"></i> Test des API</h2>";
    ...
    echo "<p><a href='$testUrl' target='_blank'><i class="fas fa-link"></i> Tester l'API des pondérations</a></p>";
    
    // Test de l'API search_history
    echo "<h3>Test Search History API:</h3>";
    $testUrl2 = 'search_history_manager.php?action=list';
    echo "<p><a href='$testUrl2' target='_blank'><i class="fas fa-link"></i> Tester l'API de l'historique</a></p>";
    
    // Test des tables
    echo "<h3>Test Table Checker:</h3>";
    $testUrl3 = 'test_tables.php';
    echo "<p><a href='$testUrl3' target='_blank'><i class="fas fa-link"></i> Vérifier les tables</a></p>";
    
    echo "</div>";
    
    echo "<h2><i class="fas fa-star"></i> Installation terminée !</h2>";
    ...
    echo "<ul>";
    echo "<li><i class="fas fa-check-circle"></i> Utiliser le bouton 'Gérer pondération' pour charger des pondérations pré-définies</li>";
    echo "<li><i class="fas fa-check-circle"></i> Utiliser le bouton 'Sauvegarder pondération' pour créer vos propres profils</li>";
    echo "<li><i class="fas fa-check-circle"></i> Utiliser le bouton 'Historique des recherches' pour voir vos recherches passées</li>";
    echo "</ul>";
    echo "<p><a href='cv_search_interface.html' style='background: #4CAF50; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;'><i class="fas fa-rocket"></i> Aller à l'interface de recherche</a></p>";
    echo "</div>";
    
} catch (Exception $e) {
    echo "<div style='background: #ffe8e8; padding: 15px; border-radius: 8px; border: 2px solid #f44336;'>";
    echo "<h2><i class="fas fa-times-circle"></i> Erreur lors de l'installation</h2>";
