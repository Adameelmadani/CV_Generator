        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            {selectedPlan && selectedPlan !== "free"
              ? `Sign in to continue with your ${selectedPlan.replace("-", " ")} plan selection`
        ...
        <Card className="shadow-xl border-0">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <Button variant="outline" className="w-full h-11" onClick={() => handleSocialLogin("github")}>
            ...
            <div className="text-center">
              <p className="text-sm text-gray-600">
                ...
                <Link
                  href={selectedPlan ? `/auth/signup?plan=${selectedPlan}` : "/auth/signup"}
