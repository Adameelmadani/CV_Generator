...
def rank_cvs_tfidf(query_vector, cv_vectors, cv_ids, query_skills=None, skills_per_cv=None):
    # Basic cosine similarity on TF-IDF vectors
    ...
    if query_skills and skills_per_cv:
        ...
        for i, cv_id in enumerate(cv_ids):
            if cv_id in skills_per_cv:
                ...
                if matches > 0:
                    # Boost proportional to the number of matching skills and their relevance
